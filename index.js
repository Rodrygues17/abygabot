...
client.on("messageCreate", async message => {
  ...
  if (!!message.content && message.content.toLowerCase() === "Abyga") {
    message.reply(`vou te mamar agora ${message.author.username}!`)
  }
})
...
client.on("interactionCreate", async interaction => {
  ...
  if (interaction.commandName === "Abyga") {
    await interaction.reply("vou te mamar agora!")
  }
})
...
const commands = [
  {
    name: "Abyga",
    description: "Receber uma mamada!",
  },
]
